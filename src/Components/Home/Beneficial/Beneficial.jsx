    ...
    return (
        <div className="mt-20 mb-10 container mx-auto">
           ...
           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5"> 
                 <h1 className="border-2 rounded-lg w-32 text-center text-2xl font-bold text-sky-500 p-5 px-1"><span></span>Students</h1>
                 ...
                 <h1 className="border-2 rounded-lg w-32 text-center text-2xl font-bold text-sky-500 p-5 px-1"><span></span>Doctors</h1>
           </div>
        </div>
    );
};
